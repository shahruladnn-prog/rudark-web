...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticPages: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/catalog/events`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
        { url: `${BASE_URL}/catalog/corporate`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
