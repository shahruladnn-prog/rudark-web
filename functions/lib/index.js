...
exports.bizappWebhook = exports.checkStock = void 0;
...
exports.bizappWebhook = functions.https.onRequest(async (req, res) => {
    var _a, _b;
    // 1. Basic Validation
    if (req.method !== 'POST') {
    ...
    try {
        ...
        try {
            ...
            if (LOYVERSE_TOKEN && (orderData === null || orderData === void 0 ? void 0 : orderData.items)) {
                const lineItems = orderData.items.map((item) => ({
                    variant_id: item.loyverse_variant_id,
                    quantity: item.quantity,
                    price: item.web_price // Sold at web price
                })).filter((l) => l.variant_id); // Only sync items linked to Loyverse
        ...
        try {
            ...
            if (PARCELASIA_API_KEY && (orderData === null || orderData === void 0 ? void 0 : orderData.customer)) {
                // Construct Payload
                ...
                const shipmentPayload = Object.assign(Object.assign({ api_key: PARCELASIA_API_KEY, integration_order_id: orderId, send_method: 'pickup', send_date: new Date().toISOString().split('T')[0], type: 'parcel', declared_weight: '1.0', provider_code: 'J&T', 
                    ...
                    size: 's', content_type: 'merchandise', content_description: 'Apparel', content_value: (orderData === null || orderData === void 0 ? void 0 : orderData.total_amount) || 0 }, senderDetails), { receiver_name: orderData.customer.name, receiver_phone: orderData.customer.phone, receiver_email: 'customer@example.com', receiver_address_line_1: orderData.customer.address, receiver_postcode: '50000', 
                    ...
                    receiver_city: 'City', receiver_state: orderData.customer.state, receiver_country_code: 'MY' });
                ...
                if (paData.status) {
                    ...
                    await orderRef.update({
                        ...
                        tracking_number: ((_a = paData.data) === null || _a === void 0 ? void 0 : _a.tracking_no) || 'PENDING',
                        shipment_key: (_b = paData.data) === null || _b === void 0 ? void 0 : _b.shipment_key
                    });
                }
                else {
